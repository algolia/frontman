...
class Frontman::App::ExistingResourceError
end

class Frontman::App::ExistingResourceError
  def self.create(url, resource); end
end
...
class Module
  ...
  def rake_original_const_missing(_); end
...
module Rake
  DeprecatedCommands = ::T.let(nil, ::T.untyped)
...
class Time
  def rake_original_time_compare(_); end
end
